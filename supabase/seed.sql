...
from (values
  ...
  -- The three below are the project owner and two named U7 managers, added so the
  -- people-and-access screen has a realistic club to administer: one person holding
  -- both an organisation-scoped admin role and a team-scoped manager role, and two
  -- holding a single team-scoped role each. Still @example.test, still no credential.
  ('00000000-0000-4000-8000-000000000206'::uuid, 'anand.kachela@example.test', '{"display_name":"Anand Kachela"}'),
  ('00000000-0000-4000-8000-000000000207'::uuid, 'rob.whittle@example.test', '{"display_name":"Rob Whittle"}'),
  ('00000000-0000-4000-8000-000000000208'::uuid, 'adrian@example.test', '{"display_name":"Adrian"}')
...
values
  ...
  ('00000000-0000-4000-8000-000000000206', 'Anand Kachela', 'adult'),
  ('00000000-0000-4000-8000-000000000207', 'Rob Whittle', 'adult'),
  ('00000000-0000-4000-8000-000000000208', 'Adrian', 'adult')
...
values
  ...
  ('00000000-0000-4000-8000-000000000306', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000206', 'active', '2026-07-01T09:00:00Z'),
  ('00000000-0000-4000-8000-000000000307', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000207', 'active', '2026-07-01T09:00:00Z'),
  ('00000000-0000-4000-8000-000000000308', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000208', 'active', '2026-07-01T09:00:00Z')
on conflict (id) do nothing;
...
values
  ...
  -- Three named U7 sides, so the access screen has more than one team to scope a
  -- manager to and the team dropdown is a real choice rather than a formality.
  ('00000000-0000-4000-8000-000000000803', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000701', '00000000-0000-4000-8000-000000000711', 'U7 Hawks'),
  ('00000000-0000-4000-8000-000000000804', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000701', '00000000-0000-4000-8000-000000000711', 'U7 Eagles'),
  ('00000000-0000-4000-8000-000000000805', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000701', '00000000-0000-4000-8000-000000000711', 'U7 Falcons')
on conflict (id) do nothing;
...
values
  ...
  -- Anand holds two roles at two different scopes, which is the case the access
  -- screen exists to make legible: club administrator across the organisation, and
  -- manager of one team only.
  ('00000000-0000-4000-8000-000000001010', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000306', '00000000-0000-4000-8000-000000000f03', 'organisation', '00000000-0000-4000-8000-000000000101'),
  -- Every manager row below is team-scoped, and must be. 0020's
  -- enforce_team_scoped_staff_roles trigger refuses 'manager' and 'coach' at
  -- organisation scope, because org-wide people:manage would hand a team manager
  -- every family record in the club.
  ('00000000-0000-4000-8000-000000001011', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000306', '00000000-0000-4000-8000-000000000f05', 'team', '00000000-0000-4000-8000-000000000803'),
  ('00000000-0000-4000-8000-000000001012', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000307', '00000000-0000-4000-8000-000000000f05', 'team', '00000000-0000-4000-8000-000000000804'),
  ('00000000-0000-4000-8000-000000001013', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000308', '00000000-0000-4000-8000-000000000f05', 'team', '00000000-0000-4000-8000-000000000805')
on conflict (id) do nothing;
